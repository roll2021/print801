...
#define USBD_MANUFACTURER_STRING        "Ipirit"

#define USBD_PRODUCT_FS_STRING          "iPRT Printer"

#define USBD_PRODUCT_HS_STRING          USBD_PRODUCT_FS_STRING
#define USBD_SERIALNUMBER_HS_STRING     USBD_SERIALNUMBER_FS_STRING

#define USBD_CONFIGURATION_FS_STRING    "PRN Config"
#define USBD_INTERFACE_FS_STRING        "PRN Interface"
...
__ALIGN_BEGIN uint8_t USBD_SERIALNUMBER_FS_STRING[SETSTRINGLEN+1] __ALIGN_END ="11101800002";
