...
#define IS_FLASH_ADDRESS(ADDRESS) (((ADDRESS) >= 0x08000000) && ((ADDRESS) <= FLASH_BANK3_ADDR_MAX))
...
#define FLASH_FLAG_BANK3_BSY                 FLASH_FLAG_BSY       /*!< FLASH BANK3 Busy flag*/
#define FLASH_FLAG_BANK3_EOP                 FLASH_FLAG_EOP       /*!< FLASH BANK3 End of Operation flag */
#define FLASH_FLAG_BANK3_PGERR               FLASH_FLAG_PGERR     /*!< FLASH BANK3 Program error flag */
#define FLASH_FLAG_BANK3_WRPRTERR            FLASH_FLAG_WRPRTERR  /*!< FLASH BANK3 Write protected error flag */
...
#endif
/*---- New Functions used only with SPIM -----*/
