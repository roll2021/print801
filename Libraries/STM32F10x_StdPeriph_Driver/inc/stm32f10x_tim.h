...
/*LIST10:TIM 2, 5*/																	 
#define IS_TIM_PLUSMODE_PERIPH(PERIPH) (((PERIPH)==TIM2) ||\
									   ((PERIPH)==TIM5))									  
/**
  * @}
  */ 
...
#define TIM_Plus_Mode_Enable              ((uint16_t)0x0400)	
#define TIM_Plus_Mode_Disable             ((uint16_t)0x0000)	
#define IS_TIM_PLUS_MODE_STATE(STATE) (((STATE) == TIM_Plus_Mode_Enable) || \
                                       ((STATE) == TIM_Plus_Mode_Disable))	
/**
  * @}
  */ 
