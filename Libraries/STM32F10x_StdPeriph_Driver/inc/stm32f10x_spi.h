...
#define SPI_BaudRatePrescaler_OVER_256                  ((uint16_t)0x8000)
...
#define SPI_BaudRatePrescaler_512       ((uint16_t)0x8000)
#define SPI_BaudRatePrescaler_1024      ((uint16_t)0x8008)
