...
/** @defgroup PLL_multiplication_factor 
 ...
 #define RCC_PLLMult_17                  RCC_CFGR_PLLMULL17 
 #define RCC_PLLMult_18                  RCC_CFGR_PLLMULL18 
 #define RCC_PLLMult_19                  RCC_CFGR_PLLMULL19 
 #define RCC_PLLMult_20                  RCC_CFGR_PLLMULL20 
 #define RCC_PLLMult_21                  RCC_CFGR_PLLMULL21 
 #define RCC_PLLMult_22                  RCC_CFGR_PLLMULL22 
 #define RCC_PLLMult_23                  RCC_CFGR_PLLMULL23 
 #define RCC_PLLMult_24                  RCC_CFGR_PLLMULL24 
 #define RCC_PLLMult_25                  RCC_CFGR_PLLMULL25 
 #define RCC_PLLMult_26                  RCC_CFGR_PLLMULL26 
 #define RCC_PLLMult_27                  RCC_CFGR_PLLMULL27 
 #define RCC_PLLMult_28                  RCC_CFGR_PLLMULL28 
 #define RCC_PLLMult_29                  RCC_CFGR_PLLMULL29 
 #define RCC_PLLMult_30                  RCC_CFGR_PLLMULL30 
 #define RCC_PLLMult_31                  RCC_CFGR_PLLMULL31 
 #define RCC_PLLMult_32                  RCC_CFGR_PLLMULL32 
 #define RCC_PLLMult_33                  RCC_CFGR_PLLMULL33 
 #define RCC_PLLMult_34                  RCC_CFGR_PLLMULL34 
 #define RCC_PLLMult_35                  RCC_CFGR_PLLMULL35 
 #define RCC_PLLMult_36                  RCC_CFGR_PLLMULL36 
 #define RCC_PLLMult_37                  RCC_CFGR_PLLMULL37 
 #define RCC_PLLMult_38                  RCC_CFGR_PLLMULL38 
 #define RCC_PLLMult_39                  RCC_CFGR_PLLMULL39 
 #define RCC_PLLMult_40                  RCC_CFGR_PLLMULL40 
 #define RCC_PLLMult_41                  RCC_CFGR_PLLMULL41 
 #define RCC_PLLMult_42                  RCC_CFGR_PLLMULL42 
 #define RCC_PLLMult_43                  RCC_CFGR_PLLMULL43 
 #define RCC_PLLMult_44                  RCC_CFGR_PLLMULL44 
 #define RCC_PLLMult_45                  RCC_CFGR_PLLMULL45 
 #define RCC_PLLMult_46                  RCC_CFGR_PLLMULL46 
 #define RCC_PLLMult_47                  RCC_CFGR_PLLMULL47 
 #define RCC_PLLMult_48                  RCC_CFGR_PLLMULL48 
 #define RCC_PLLMult_49                  RCC_CFGR_PLLMULL49 
 #define RCC_PLLMult_50                  RCC_CFGR_PLLMULL50 
 #define RCC_PLLMult_51                  RCC_CFGR_PLLMULL51 
 #define RCC_PLLMult_52                  RCC_CFGR_PLLMULL52 
 #define RCC_PLLMult_53                  RCC_CFGR_PLLMULL53 
 #define RCC_PLLMult_54                  RCC_CFGR_PLLMULL54 
 #define RCC_PLLMult_55                  RCC_CFGR_PLLMULL55 
 #define RCC_PLLMult_56                  RCC_CFGR_PLLMULL56 
 #define RCC_PLLMult_57                  RCC_CFGR_PLLMULL57 
 #define RCC_PLLMult_58                  RCC_CFGR_PLLMULL58 
 #define RCC_PLLMult_59                  RCC_CFGR_PLLMULL59 
 #define RCC_PLLMult_60                  RCC_CFGR_PLLMULL60 
 #define RCC_PLLMult_61                  RCC_CFGR_PLLMULL61 
 #define RCC_PLLMult_62                  RCC_CFGR_PLLMULL62 
 #define RCC_PLLMult_63                  RCC_CFGR_PLLMULL63 
 #define RCC_PLLMult_64                  RCC_CFGR_PLLMULL64 
 #define IS_RCC_PLL_MUL(MUL)             (((MUL) & (~RCC_CFGR_PLLMULL)) == 0x00000000)
 
 #define RCC_GET_PLLMULT(MULT)           ( ( ((MULT & RCC_CFGR_PLLMULL_LB_MASK) >> RCC_CFGR_PLLMULL_LB_POS) | \
                                            ((MULT & RCC_CFGR_PLLMULL_HB_MASK) >> (RCC_CFGR_PLLMULL_HB_POS - RCC_CFGR_PLLMULL_HB_OFFSET))) +\
                                          ( (((MULT & RCC_CFGR_PLLMULL_HB_MASK)==0) && \
                                            ((MULT & RCC_CFGR_PLLMULL_LB_MASK)!=RCC_CFGR_PLLMULL_LB_MASK) )? 2 : 1 ) )
...
/** @defgroup USB_Device_clock_source 
 ...
 #define RCC_USBCLKSource_PLLCLK_3Div5    ((uint32_t)0x08000000)
 #define RCC_USBCLKSource_PLLCLK_Div3     ((uint32_t)0x08400000)
 #define RCC_USBCLKSource_PLLCLK_Div4     ((uint32_t)0x08800000)
 ...
 #define IS_RCC_USBCLK_SOURCE(SOURCE) (((SOURCE) == RCC_USBCLKSource_PLLCLK_1Div5) || \
                                      ((SOURCE) == RCC_USBCLKSource_PLLCLK_Div1) || \
																			...
																			((SOURCE) == RCC_USBCLKSource_PLLCLK_Div3)  || \
...
#define RCC_PCLK2_Div12           			 ((uint32_t)0x10004000)
#define RCC_PCLK2_Div16           			 ((uint32_t)0x1000C000)
#define IS_RCC_ADCCLK(ADCCLK) (((ADCCLK) == RCC_PCLK2_Div2) || ((ADCCLK) == RCC_PCLK2_Div4) || \
                               ((ADCCLK) == RCC_PCLK2_Div6) || ((ADCCLK) == RCC_PCLK2_Div8) || \
															 ((ADCCLK) == RCC_PCLK2_Div12) || ((ADCCLK) == RCC_PCLK2_Div16))
/**
  * @}
  */
...
#define RCC_MCO_SYSCLK           ((uint32_t)0x04000000)
#define RCC_MCO_HSI              ((uint32_t)0x05000000)
#define RCC_MCO_HSE              ((uint32_t)0x06000000)
#define RCC_MCO_PLLCLK_Div2      ((uint32_t)0x07000000)
#define RCC_MCO_PLLCLK_Div4      ((uint32_t)0x14000000)
#define RCC_MCO_USB              ((uint32_t)0x15000000)
#define RCC_MCO_ADC              ((uint32_t)0x16000000)

#ifndef STM32F10X_CL
 #define IS_RCC_MCO(MCO) (((MCO) == RCC_MCO_NoClock) || ((MCO) == RCC_MCO_HSI) || \
                          ((MCO) == RCC_MCO_SYSCLK)  || ((MCO) == RCC_MCO_HSE) || \
                          ((MCO) == RCC_MCO_PLLCLK_Div2) || ((MCO) == RCC_MCO_PLLCLK_Div4) || \
													((MCO) == RCC_MCO_USB) || ((MCO) == RCC_MCO_ADC))
#else
...
#define IS_RCC_MCO_PRE(MCOPRE)      (((MCOPRE) == RCC_MCOPRE_1)    || ((MCOPRE) == RCC_MCOPRE_2)      || \
