...
;* File Name          : startup_stm32f10x_atf403a.s
;* Author             : MCD Application Team
;* Version            : V3.5.0
;* Date               : 11-March-2011
;* Description        : ATF403Axx Devices vector table for EWARM 
;*                      toolchain.
...
__vector_table
        ...
        DCD     TIM6_GLOBAL_IRQHandler        ; TIM6
        DCD     TIM7_GLOBAL_IRQHandler        ; TIM7
...
UART5_IRQHandler
        ...
        PUBWEAK TIM6_GLOBAL_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
TIM6_GLOBAL_IRQHandler
        B TIM6_GLOBAL_IRQHandler

        PUBWEAK TIM7_GLOBAL_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
TIM7_GLOBAL_IRQHandler
        B TIM7_GLOBAL_IRQHandler
